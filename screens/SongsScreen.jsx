        ...
        <View style={{ marginBottom: 16}}>
          <View className=" flex-row justify-between mb-4">
            ...
            {/* <Pressable 
              ...
              <Text className="text-gray-background font-bold text-xl mt-1">Add Song</Text>
            </Pressable> */}
          </View>
          ...
          <View style={{gap: 8, marginBottom: 32}}>
            <View className="flex-row justify-between w-full">
              <Text className="text-brand-navy text-xl mb-2">Your Songs</Text>
              <Text className="text-brand-navy opacity-60 text-xl mb-2">Most Recent</Text>
            </View>
          ...
          <View style={{gap: 8, marginBottom: 128}}>
            <View className="flex-row justify-between w-full">
              <Text className="text-brand-navy text-xl mb-2">All Saved Songs</Text>
              <Text className="text-brand-navy opacity-60 text-xl mb-2">Most Recent</Text>
            </View>
